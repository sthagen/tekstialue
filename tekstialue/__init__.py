...
APP_NAME = (
    'Text area (Finnish: tekstialue) - tune planar arrangements of text (tables)'
    ' to preserve styles across transforms.'
)
APP_ALIAS = 'tekstialue'
APP_ENV = 'TEKSTIALUE'
COMMA = ','
...
DEFAULT_CONFIG_NAME = '.tekstialue.json'
DEFAULT_LF_ONLY = 'YES'
